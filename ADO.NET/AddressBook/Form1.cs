...
namespace AddressBook
{
    public partial class Form1 : Form
    {
        ...
        private void btConnect_Click(object sender, EventArgs e)
        {
            ...
            // TODO: このコード行はデータを 'infosys202121DataSet.Person' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
            this.personTableAdapter.Fill(this.infosys202121DataSet.Person);
        }

        private void btNameFilter_Click(object sender, EventArgs e)
        {
           this.personTableAdapter.FillByName(this.infosys202121DataSet.Person,tbNameSearch.Text);
        ...
        private void btBirthdayFill_Click(object sender, EventArgs e)
        {
            this.personTableAdapter.FillByBirthday(this.infosys202121DataSet.Person, dateTimePicker1.Text);
        }
    }
}
